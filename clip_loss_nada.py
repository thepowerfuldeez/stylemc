...
class CLIPLoss(torch.nn.Module):
    ...
    def distance_with_templates(self, img: torch.Tensor, class_str: str, templates=imagenet_templates_small) -> torch.Tensor:
    ...
    def compose_text_with_templates(self, text: str, templates=imagenet_templates_small) -> list:
